            ...
            >
              ...
              <div className="space-y-4 mb-6">
                ...
                <div className="flex items-center justify-between p-4 rounded-2xl bg-purple-50/70 border border-purple-100">
                  ...
                  <button
                    onClick={toggleBgm}
                    className={`px-4 py-1.5 rounded-full font-orbitron font-black text-xs transition-all duration-200 shadow-sm cursor-pointer ${isBgmEnabled
                ...
                <div className="flex items-center justify-between p-4 rounded-2xl bg-purple-50/70 border border-purple-100">
                  ...
                  <button
                    onClick={toggleSfx}
                    className={`px-4 py-1.5 rounded-full font-orbitron font-black text-xs transition-all duration-200 shadow-sm cursor-pointer ${isSfxEnabled
                        ? 'bg-emerald-500 text-white hover:bg-emerald-600 shadow-emerald-500/30'
                        : 'bg-slate-300 text-slate-700 hover:bg-slate-400'
                      }`}
                  >
              ...
              {GAME_PADS.map((pad) => {
                ...
                return (
                  <button
                    ...
                    className={`w-14 h-14 sm:w-16 sm:h-16 rounded-2xl border-2 ${pad.border} ${pad.bg} transition-all duration-200 flex items-center justify-center cursor-pointer transform active:scale-90 ${isActive ? pad.activeGlow : `${pad.glow} hover:scale-105 hover:brightness-110`
                      }`}
                  >
