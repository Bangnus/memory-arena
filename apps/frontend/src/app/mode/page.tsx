...
import { Zap, ZapOff, Gamepad2, ChevronLeft, ChevronRight, ArrowLeft } from 'lucide-react';
...
export default function ModePage() {
  ...
  return (
    <main className="flex h-screen max-h-screen w-screen flex-col items-center justify-center bg-gradient-to-br from-sky-400 via-blue-500 to-orange-400 relative overflow-hidden text-white py-4 px-4">
