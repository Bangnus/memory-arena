...
export function GameOverlays({
  ...
  return (
    <>
      {/* Standalone Centered Countdown Modal (Independent of color console size) */}
      <AnimatePresence>
        {activeCountdown !== null && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/50 backdrop-blur-sm pointer-events-none">
            <motion.div 
              ...
              className="w-64 h-64 md:w-72 md:h-72 rounded-[3rem] bg-slate-950/95 border-4 border-amber-400 shadow-[0_0_60px_rgba(251,191,36,0.5)] backdrop-blur-2xl flex flex-col items-center justify-center p-4"
            >
              <div className="text-xs md:text-sm font-black font-orbitron text-amber-300 uppercase tracking-widest mb-1 drop-shadow-md">
                {roundCountdown !== null ? 'NEXT ROUND IN' : 'GET READY!'}
              </div>
              ...
              <AnimatePresence mode="wait">
                <motion.div
                  ...
                  className="text-8xl md:text-9xl font-black font-orbitron text-amber-400 drop-shadow-[0_0_40px_rgba(251,191,36,0.9)]"
                >
