...
Memory Arena เป็นเกมแข่งขันประลองความจำระดับมิลลิวินาทีของผู้เล่น 2 คน รองรับปุ่มสี **4 สีหลัก** (**แดง, เขียว, น้ำเงิน, เหลือง**) แข่งขันกันในรูปแบบชนะ 3 ใน 5 รอบ (**Best of 5: First to 3 Points**)

### ระดับความยาก (Difficulty Modes)
ผู้เล่นสามารถเลือกปรับระดับความยากผ่านปุ่มควบคุมบนบอร์ดหรือหน้าเว็บก่อนเริ่มเกมได้ 3 ระดับ:
* **Easy (ง่าย):** ลำดับโจทย์ 4 ขั้นตอน (ความเร็วแสดงผลดวงละ 0.9 วินาที / 900ms)
* **Medium (ปานกลาง):** ลำดับโจทย์ 5 ขั้นตอน (ความเร็วแสดงผลดวงละ 0.7 วินาที / 700ms)
* **Hard (ยาก):** ลำดับโจทย์ 6 ขั้นตอน (ความเร็วแสดงผลดวงละ 0.5 วินาที / 500ms)
